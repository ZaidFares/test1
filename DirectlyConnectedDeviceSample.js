 ...
 */
var sensorPollingInterval = 5000;
...
*
* @param {iotcs.device.DirectlyConnectedDevice} device a humidity sensor device.
...
try {
    ...
    var dcd = new iotcs.device.DirectlyConnectedDevice(trustedAssetsStoreFile, trustedAssetsStorePassword);
} catch (err) {
    console.error(err);
    showUsage();
    process.exit(1);
